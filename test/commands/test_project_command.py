...
from timereporter.commands.project_command import (
    ProjectCommand,
    ProjectNameDoesNotExistError,
...
class TestProjectCommand:
    def test_project_not_existing_error(self, mockdate_tuesday):
        with pytest.raises(ProjectNameDoesNotExistError):
            ...
            # error prone.
            pc = ProjectCommand(
                Calendar(), mockdate_tuesday, ["project", "EPG Support", "9"]
            )
            pc.execute()
    ...
    def test_report_time_short_form_ambiguity(self, mockdate_tuesday):
        calendar = Calendar()
        pc = ProjectCommand(
            calendar, mockdate_tuesday, ["project", "new", "EPG Support"]
        )
        calendar, view = pc.execute()
        pc = ProjectCommand(
            calendar, mockdate_tuesday, ["project", "new", "EPG Maintenance"]
        )
        calendar, view = pc.execute()
    ...
    def test_unexpected_option_creating_new_error(self, mockdate_tuesday):
        with pytest.raises(UnexpectedOptionError):
            pc = ProjectCommand(
                Calendar(), mockdate_tuesday, "project new Hello World".split()
            )
            pc.execute()
    ...
    def test_unexpected_option_reporting_name_error(self, mockdate_tuesday):
        with pytest.raises(UnexpectedOptionError):
            pc = ProjectCommand(
                Calendar(), mockdate_tuesday, "project Hello World 7".split()
            )
            pc.execute()

    def test_unexpected_option_reporting_number_error(self, mockdate_tuesday):
        with pytest.raises(UnexpectedOptionError):
            pc = ProjectCommand(Calendar(), mockdate_tuesday, "project 1 2 7".split())
            pc.execute()
...
class TestReportTimeByProjectNumber:
    def test_default_project(self, mockdate_tuesday, project_calendar):
        pc = ProjectCommand(
            project_calendar, mockdate_tuesday, "project 1 " "8".split()
        )
    ...
    def test_other_project(self, mockdate_tuesday, project_calendar):
        pc = ProjectCommand(
            project_calendar, mockdate_tuesday, "project 2 " "8".split()
        )
        calendar, view = pc.execute()
        assert "08:00" in view.show(calendar)

    def test_project_number_not_existing(self, mockdate_tuesday, project_calendar):
        pc = ProjectCommand(
            project_calendar, mockdate_tuesday, "project 3 " "8".split()
        )
    ...
    def test_project_starting_with_a_digit(self, mockdate_tuesday, project_calendar):
    ...
    def test_show_digits_before_projects(self, mockdate_tuesday, project_calendar):
        pc = ProjectCommand(
            project_calendar, mockdate_tuesday, "project 2 " "8".split()
        )
        calendar, view = pc.execute()
    ...
    def test_invalid_time_no_time(self, mockdate_tuesday, project_calendar):
        pc = ProjectCommand(project_calendar, mockdate_tuesday, "project " "2".split())
